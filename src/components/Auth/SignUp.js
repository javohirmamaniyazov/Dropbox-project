  ...
  render() {
    ...
    return (
      <>
        ...
        <div className='jumbotron d-flex align-items-center min-vh-100 p-0' style={{ backgroundColor: '#f8f9fa' }}>
          <div className='container py-5 mt-5'>
            <form className='mx-auto p-3 bg-white rounded' style={{ maxWidth: '400px', borderRadius: '20px', boxShadow: '0px 0px 5px 0px rgba(0,0,0,0.2)' }} onSubmit={this.handleSubmit}>
              <div className='pb-2'>
                <h2 className='text-center display-4'>Register</h2>
              </div>
              <div className='form-group mt-2 form-font'>
              ...
              <div className='text-center'>
                <button type='submit' className='w-100 btn btn-primary' style={{ height: '55px' }}>
                  register
                </button>
              </div>
            </form>
            <div className='text-center mt-3'>
              <p>Already have an account? <a href='#' className='' style={{textDecoration: "none"}} onClick={() => this.setState({ login: true })}>
                Sign in
              </a></p>
            </div>
          </div>
